...
class SchooljaarVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_schooljaar_vocabulary(self):
        vocab_name = 'medialog.hilversum.SchooljaarVocabulary'
