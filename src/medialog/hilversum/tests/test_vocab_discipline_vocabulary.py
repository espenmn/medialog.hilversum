...
class DisciplineVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_discipline_vocabulary(self):
        vocab_name = 'medialog.hilversum.DisciplineVocabulary'
