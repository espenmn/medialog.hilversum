...
class OnderwijstypeVocabularyIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_onderwijstype_vocabulary(self):
        vocab_name = 'medialog.hilversum.OnderwijstypeVocabulary'
