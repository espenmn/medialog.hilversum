...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_providers_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='providers-view'
        )
        self.assertTrue(view.__name__ == 'providers-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in providers-view'
        # )

    def test_providers_view_not_matching_interface(self):
