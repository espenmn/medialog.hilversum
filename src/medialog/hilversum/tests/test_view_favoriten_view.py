...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_favoriten_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='favoriten-view'
        )
        self.assertTrue(view.__name__ == 'favoriten-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in favoriten-view'
        # )

    def test_favoriten_view_not_matching_interface(self):
